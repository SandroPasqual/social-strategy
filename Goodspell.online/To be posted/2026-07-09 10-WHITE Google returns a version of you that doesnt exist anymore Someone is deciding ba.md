...
status: to_be_posted
type: text
image_text: "*Google returns a version of you* *that doesn't exist anymore.* *Someone is deciding based on that version right now.*"
---
...
You're not in that decision. The old version of you is.
